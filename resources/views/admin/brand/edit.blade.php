...
<section class="content">
    ...
    <div class="container-fluid">
                ...
                <div class="row  d-flex center justify-content-center">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="file" value="{{ $brand->image }}" name="image" id="image" class="form-control  @error('image') is-invalid @enderror" placeholder="Name">	
                        </div>
                    </div>
      ...
      <img src="/images/{{ $brand->image }}"  height="250px" width="500px" at="">
                        </div>
                    </div>
